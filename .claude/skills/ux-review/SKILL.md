...
> **Note on gitignored paths:** `tests//ux-review/` is gitignored to keep screenshots out of version control, but they are still fully readable from disk. Always use the `Read` tool with the explicit file path to view saved screenshots — `.gitignore` only affects git, not filesystem access.

#### 4.1 Capture Screenshots for Key States

```bash
# Take screenshot of initial state
agent-browser screenshot --path tests//ux-review/ux-review-initial.png
...
agent-browser screenshot --path tests//ux-review/ux-review-after-action.png

# Capture dialog if expected
agent-browser screenshot --path tests//ux-review/ux-review-dialog.png
```
...
```
tests//ux-review/ux-review-{feature}-{state}.png

Examples:
- tests//ux-review/ux-review-stages-initial.png
- tests//ux-review/ux-review-stages-dropdown-removed.png
- tests//ux-review/ux-review-stages-worker-busy-dialog.png
- tests//ux-review/ux-review-stages-after-queue.png
```
...
- `tests//ux-review/ux-review-stages-initial.png` - Stages section without dropdown
- `tests//ux-review/ux-review-stages-worker-busy.png` - Confirmation dialog appearance
...
agent-browser screenshot --path tests//ux-review/ux-review-full.png

# Take screenshot of specific element
agent-browser screenshot --selector ".container" --path tests//ux-review/ux-review-section.png

# Capture before/after states
agent-browser screenshot --path tests//ux-review/ux-review-before.png
agent-browser click "@action-button"
sleep 1
agent-browser screenshot --path tests//ux-review/ux-review-after.png
...
sleep 1
agent-browser screenshot --path tests//ux-review/ux-review-error.png
```
