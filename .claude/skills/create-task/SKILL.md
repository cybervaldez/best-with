---
name: create-task
description: Plan and implement tasks for the spotify-liked WebUI with e2e test validation. Use when the user asks to implement a feature, fix a bug, update functionality, or any task that modifies the WebUI codebase.
...
You are implementing tasks for the spotify-liked WebUI. Each task includes planning, implementation, and **automated e2e test validation**.
